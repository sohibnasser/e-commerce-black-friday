...
export default function New_Arrivals() {
  return (
    <Container>
        <section className="secion_New_Arrivals">

            <div className="image_Wrapper">
                <img className="img_New_Arrivals" src={img1} alt="img_New_Arrivals"/>
            </div>
        ...
        <Row className="boxWrapper" xs={1} sm={2} md={2}  lg={2} xl={2}>


          <Col><div class="cardOurService wallet">
          ...
          <Col><div class="cardOurService wallet">
              ...
              <p>" استضافة المواقع الالكترونية "</p>
              </div>
            </Col>
